...
export default function PersonalizationPage({ onBack, onNext, toolType = 'audio' }) {
  ...
  useEffect(() => {
    try {
      ...
      if (savedData && savedData.personalMessage) {
        setPersonalMessage(savedData.personalMessage);
      }
    } catch (error) {
