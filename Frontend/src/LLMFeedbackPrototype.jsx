      ...
      general: [
        {
          id: 1,
          sender: 'assistant',
          message: 'Hallo! 👋 Ich bin dein KI-Assistent und helfe dir dabei, dein musikalisches Spiel zu verbessern. Insgesamt zeigt deine Aufnahme viele positive Aspekte und einige Bereiche, an denen wir gemeinsam arbeiten können. Wie fühlst du dich nach dem Üben? Gibt es etwas Bestimmtes, worüber du sprechen möchtest?',
          timestamp: new Date(),
          feedbackType: 'neutral'
        }
      ]
