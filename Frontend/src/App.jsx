...
import Mp3ToMidiConvertingPage from './pages/mp3-to-midi-feedback/Mp3ToMidiConvertingPage.jsx'
...
export default function App() {
  ...
  // MP3-to-MIDI Flow (vereinfacht: Upload → Konvertierung → Ergebnis)
  if (page === 'mp3-to-midi-upload') {
    return <Mp3ToMidiUploadPage onNext={() => setPage('mp3-to-midi-converting')} onShowResult={() => setPage('mp3-to-midi-result')} />
  }

  if (page === 'mp3-to-midi-converting') {
    return <Mp3ToMidiConvertingPage onBack={() => setPage('mp3-to-midi-upload')} onNext={() => setPage('mp3-to-midi-result')} />
  }
